...
export function systemPrompt() {
  ...
  return [
    ...
    `- Prefer edit_file/multi_edit over write_file. Prefer the smallest action that achieves the goal.`,
    `- To locate code, use grep_files (content) and find_files (names) -- they are native and cheap. Do not shell out to grep/find/ls -R.`,
...
export function offlineSystemPrompt() {
  ...
  return [
    ...
    '- Prefer edit_file/multi_edit over write_file. Use grep_files/find_files to locate code.',
